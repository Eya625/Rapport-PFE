...
% Diagramme 1 : Consulter Profil
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{C:/Users/bouka/Downloads/imageslatex/DS consulter profil.png}
  \caption{Diagramme de séquence : Consulter Profil}
  \label{fig:consulter_profil}
\end{figure}

% Diagramme 2 : Modifier données profil
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{C:/Users/bouka/Downloads/imageslatex/modif profil.png}
  \caption{Diagramme de séquence : Modifier données du profil}
  \label{fig:modifier_donnees_profil}
\end{figure}

\vspace*{\fill}  % pousse vers le bas pour centrer verticalement

\begin{figure}[p]
  \centering
  \includegraphics[
    width=0.9\textwidth,       % 90% de la largeur du texte
    height=0.9\textheight,     % 90% de la hauteur du texte
    keepaspectratio            % pour ne pas déformer
  ]{C:/Users/bouka/Downloads/imageslatex/modifpsw.png}
  \caption{Diagramme de séquence : Modifier mot de passe}
  \label{fig:modifier_mot_de_passe_plein}
\end{figure}

\vspace*{\fill}  % pousse vers le haut pour finir le centrage vertical
